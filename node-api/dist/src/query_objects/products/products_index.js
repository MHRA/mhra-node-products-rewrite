...
import { AzureBlobStorage } from "../../blob-storage.js";
...
export class ProductsDataSource {
    ...
    constructor() {
        ...
        this.BlobStorage = new AzureBlobStorage(process.env.STORAGE_CONTAINER_TEMPORARY, "", process.env.STORAGE_ACCOUNT_TEMPORARY, process.env.STORAGE_MASTER_KEY_TEMPORARY);
    }
    /**
    ...
    */
    async get_products_associated_with_substances(substance) {
        // Log the substance for debugging
        console.log("Substance is ", substance);
    ...
    */
    async search_product_documents(search, first, skip, after, document_types, territory_types) {
        ...
        console.log("Current search data is ", search_data.value);
