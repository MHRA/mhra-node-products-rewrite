...
export class QueryNormalizer {
     ...
     */
    normalize_product_licences(searchTerm) {
     ...
     */
    prefer_exact_match_but_support_fuzzy_match(word, searchWordFuzziness, searchExactnessBoost) {
     ...
     * @example
     */
    escape_special_characters(searchTerm) {
     ...
     */
    escape_special_words(searchTerm) {
