...
export class AuthManager {
   ...
   */
  auth_is_correct = (username: string, password: string): boolean => {
   ...
   */
  attempt_basic_auth = (auth_header: string): boolean => {
   ...
   */
  decode_credentials = (encoded_credentials: string): [string, string] | null => {
      try {
   ...
   */
  extract_encoded_credentials = (auth_header: string): string | null => {
   ...
   */
  extract_username_and_password = (decoded_credentials: string): [string, string] | null => {
