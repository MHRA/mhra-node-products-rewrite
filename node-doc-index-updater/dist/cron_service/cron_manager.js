...
export class CronManagerService {
    ...
    async create_manager_create_cron_job(time_to_wait) {
    ...
    async create_manager_create_clean_up_cron_job(time_to_wait) {
    ...
    async delete_manager_delete_cron_job(time_to_wait) {
        cron.schedule('0 */10 * * *', async () => {
    ...
    async delete_manager_delete_clean_up_cron_job(time_to_wait) {
        cron.schedule('0 */10 * * *', async () => {
